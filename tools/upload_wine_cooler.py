"""Upload wine cooler page images and HTML via Plesk FTPS."""
...
FILES = [
    (ROOT / "wine-cooler-repair-london.html", "wine-cooler-repair-london.html"),
    (ROOT / "wine-cooler-repair-london" / "index.html", "wine-cooler-repair-london/index.html"),
]
...
def main() -> int:
    ...
    ftp = d.diagnose(cfg)
    if ftp is None:
        print("FTP login failed", flush=True)
        return 1
    base = cfg["path"]
    try:
        ftp.cwd(base)
