...
Notes: 2026-09-16 max 2 service pages (commercial fridge already OK; next freezer pages). Folder index.html copies kept in sync. Header, hero, CTA and footer otherwise unchanged.
